...
class FragmentProductosInicio : Fragment(), View.OnClickListener {
            ...
            val jsonArrayRequest = JsonArrayRequest(
                ...
                {response ->
                    for(i in 0 until response.length()){
                        ...
                        listaProductos.add(i, arrayListOf(actual.getString("nombre"),actual.getString("precio"),actual.getString("paquete"),actual.getString("descripcion")))
                    }
    ...
    override fun onClick(row: View) {
        ...
        intent.putExtra("paquete",listaProductos[position][2])
        intent.putExtra("descripcion",listaProductos[position][3])
